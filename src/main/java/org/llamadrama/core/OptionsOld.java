...
public record OptionsOld(Path modelPath, String prompt, String systemPrompt, boolean interactive,
...
//        if (!condition) {
//            System.out.printf("ERROR %s%n", messageFormat.formatted(args));
//            System.out.println();
...
//    }
//
//    static OptionsOld parseOptions(String[] args) {
//        String prompt = null;
...
//            }
//        }
//        return new OptionsOld(modelPath, prompt, systemPrompt, interactive, temperature, topp, seed, maxTokens, stream, echo);
//    }
}
